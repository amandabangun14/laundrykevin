...
<head>
    ...
    <title>@yield('title', 'Kevin Laundry')</title>
        ...
        <nav class="px-4 py-6">
            @if(auth()->user()->isAdmin())
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('admin.orders') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.orders*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                        <i class="fas fa-list-alt w-5 h-5 mr-3"></i>
                        Kelola Pesanan
                    </a>
                    <a href="{{ route('admin.customers') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.customers*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                        <i class="fas fa-users w-5 h-5 mr-3"></i>
                        Data Customer
                    </a>
                    <a href="{{ route('admin.services') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.services*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                        <i class="fas fa-cogs w-5 h-5 mr-3"></i>
                        Layanan & Harga
                    </a>
                    <a href="{{ route('admin.reports') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.reports*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                        <i class="fas fa-chart-bar w-5 h-5 mr-3"></i>
                        Laporan
                    </a>
                    <a href="{{ route('admin.settings') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.settings*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
