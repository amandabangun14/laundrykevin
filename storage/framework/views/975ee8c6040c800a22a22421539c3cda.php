        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    <a href="<?php echo e(route('admin.orders')); ?>" class="text-blue-600 hover:text-blue-800 mr-4">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900"><?php echo e($order->customer->name); ?></p>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900"><?php echo e($order->notes ?: 'Tidak ada catatan'); ?></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex-1">
                            ...
                            <select name="status" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                                ...
                                <option value="received" <?php echo e($order->status === 'received' ? 'selected' : ''); ?>>Diterima</option>
                                <option value="washing" <?php echo e($order->status === 'washing' ? 'selected' : ''); ?>>Mencuci</option>
                                <option value="ironing" <?php echo e($order->status === 'ironing' ? 'selected' : ''); ?>>Menyetrika</option>
                                <option value="completed" <?php echo e($order->status === 'completed' ? 'selected' : ''); ?>>Selesai</option>
                                <option value="ready_for_pickup" <?php echo e($order->status === 'ready_for_pickup' ? 'selected' : ''); ?>>Siap Diambil</option>
                                <option value="picked_up" <?php echo e($order->status === 'picked_up' ? 'selected' : ''); ?>>Sudah Diambil</option>
                            </select>
                        </div>
...
</html> <?php /**PATH C:\laragon\www\kevinlaundry\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>