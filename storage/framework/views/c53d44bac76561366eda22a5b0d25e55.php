...
<?php $__env->startSection('title', 'Kelola Pesanan - Kevin Laundry'); ?>
...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="<?php echo e(route('admin.orders.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 transition-colors">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="text-blue-600 hover:text-blue-900 mr-3">
                            <i class="fas fa-eye"></i>
                        </a>
                        <button class="text-green-600 hover:text-green-900" onclick="updateStatus('<?php echo e($order->id); ?>')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kevinlaundry\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>